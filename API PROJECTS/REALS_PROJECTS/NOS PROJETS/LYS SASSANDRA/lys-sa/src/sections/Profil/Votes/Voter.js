            ...
            <Row className="justify-content-center py-5">
              <Col lg="12">
                ...
                <div className="form-title ">
                  ...
                  <div className="bg-red border rounded-10 px-8 py-8 shadow-1 mb-11">
                  <div className="price-content">
                            <div className="d-flex">
                                ...
                                <div className="text ">
                                    <p className="gr-text-8 text-blackish-blue text-white">
                                        Quel joueur de LYS marquera le premier but de la rencontre LYS vs Stella Club d'Adjamé?
                                    </p>
                                    <span className="btn-bottom-text text-white d-block gr-text-11 text-blackish-blue gr-opacity-10 mt-3">
                    ...
                    <p className="gr-text-5 mb-13 text-color-opacity">
                    ...
                    <Col lg="4" md="6" sm="10" className="mb-5">
                        ...
                        <p className="gr-text-10 text-blackish-blue mt-10">
                        attaquant, meilleur buteur du club.
                        </p>
