      ...
      <Container>
        ...
        <Row>
          <Col lg="5">
            ...
            >
              <img className="w-100 rounded-10" src={"/image/l5/jpg/l5-about-big.jpg"} alt="" />
            </div>
          </Col>
          <Col lg="7">
            <Row className="justify-content-between align-items-center ps-lg-13">
              <Col md="6">
                ...
                >
                  <img className="w-100 rounded-10" src={"/image/l5/jpg/l5-about-mid.jpg"} alt="" />
                  <div
                    ...
                    data-aos-delay="300"
                  >
                    <img src={"/image/l5/png/l5-about-pattern.png"} alt="" />
                  </div>
                </div>
              </Col>
              <Col md="5">
                ...
                >
                  <img className="rounded-10" src={"/image/l5/jpg/l5-about-sm.jpg"} alt="" />
                </div>
              </Col>
              <Col xl="10">
