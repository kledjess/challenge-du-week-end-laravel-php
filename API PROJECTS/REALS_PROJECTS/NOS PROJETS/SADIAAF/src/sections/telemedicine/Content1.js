              ...
              >
                <div className="abs-image-1 responsive-scaling-2">
                  <div className="animation-item">
                    <img
                      className="main-img"
                      src={"/image/telemedicine/png/content-1-img1.png"}
                      alt=""
                      id="an-item-2p1"
                    />
                  </div>
                ...
                <div className="abs-image-2 responsive-scaling-2">
                  <div className="animation-item">
                    <img
                      className="main-img"
                      src={"/image/telemedicine/png/content-1-img2.png"}
                      alt=""
                      id="an-item-2p2"
                    />
                  </div>
                ...
                <div className="gr-abs-center gr-z-index-n1">
                  <img src={"/image/telemedicine/png/content1-img-sub.png"} alt="" className="responsive-scaling-2" />
                </div>
              </div>
            </Col>
