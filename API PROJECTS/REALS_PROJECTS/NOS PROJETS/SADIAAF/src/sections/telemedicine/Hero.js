          ...
          <Row className="align-items-center justify-content-center">
            ...
            >
              <div
                ...
                data-aos-delay="500"
              >
                <img className="w-100" src={"/image/telemedicine/png/hero-img-main.png"} alt="" />
                <div className="image-bg-positioning">
                  <img src={"/image/telemedicine/png/hero-img-sub.png"} alt="" />
                </div>
              </div>
              <div className="hero-sm-card-1">
                ...
                >
                  ...
                  <div className="small-card-img ms-6">
                    <img src={"/image/telemedicine/png/hero-card-1.png"} alt="" className="circle-42" />
                  </div>
                </div>
              </div>
              <div className="animation-item">
                ...
                >
                  <div className="small-card-img me-6 text-white">
                    <img src={"/image/telemedicine/png/hero-card-2.png"} alt="" className="circle-42" />
                  </div>
