    ...
    <>
      ...
      <div className="pricing-section bg-default-2 pt-14 pt-lg-24 pb-23 pb-lg-31 position-relative gr-z-index-1">
        ...
        <div className="wave-shape gr-abs-br">
          <img src={"/image/svg/l6-footer-wave.svg"} alt="" className="w-100 light-shape default-shape" />
          <img src={"/image/svg/l6-footer-wave-dark.svg"} alt="" className="w-100 dark-shape" />
        </div>
        <div
          ...
          data-aos-delay="400"
        >
          <img src={"/image/l6/png/l6-footer-pattern.png"} alt="" />
        </div>
      </div>
    </>
  );
