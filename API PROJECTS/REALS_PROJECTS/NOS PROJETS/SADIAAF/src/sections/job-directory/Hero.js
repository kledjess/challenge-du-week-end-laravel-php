        ...
        <Row className="justify-content-sm-end">
          ...
          <Col lg="5" md="4" sm="7" className="offset-lg-1 align-self-sm-end">
            <div
              ...
              data-aos-delay="500"
            >
              <img className="w-100" src={"/image/job-site/png/hero-img-big.png"} alt="" />
              <div
                ...
                data-aos-delay="1000"
              >
                <img src={"/image/job-site/png/hero-dot-pattern.png"} alt="" />
              </div>
              <div
                ...
                data-aos-delay="1000"
              >
                <img src={"/image/job-site/png/hero-oval-shape.png"} alt="" />
              </div>
            </div>
          </Col>
        </Row>
