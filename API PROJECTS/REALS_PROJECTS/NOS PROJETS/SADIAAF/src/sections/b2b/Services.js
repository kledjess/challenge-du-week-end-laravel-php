          ...
          <Row className="align-items-center justify-content-center">
            <Col lg="4" md="6" sm="10" className="mb-13 mb-lg-0">
              <div className="service-card">
                ...
                <div className="img-thumb mb-8">
                  <img className="rounded-10 w-100" src={"/image/l3/jpg/l3-service-img1.jpg"} alt="" />
                </div>
            ...
            <Col lg="4" md="6" sm="10" className="mb-13 mb-lg-0">
              <div className="service-card">
                ...
                <div className="img-thumb mb-8">
                  <img className="rounded-10 w-100" src={"/image/l3/jpg/l3-service-img2.jpg"} alt="" />
                </div>
                <p className="excerpt gr-text-9 text-color-opacity mb-6">
                  With lots of unique blocks, you can easily build a page
                  without coding. Build your next landing page.
            ...
            <Col lg="4" md="6" sm="10" className="mb-13 mb-lg-0">
              <div className="service-card">
                ...
                <div className="img-thumb mb-8">
                  <img className="rounded-10 w-100" src={"/image/l3/jpg/l3-service-img3.jpg"} alt="" />
                </div>
                <p className="excerpt gr-text-9 text-color-opacity mb-6">
                  With lots of unique blocks, you can easily build a page
                  without coding. Build your next landing page.
