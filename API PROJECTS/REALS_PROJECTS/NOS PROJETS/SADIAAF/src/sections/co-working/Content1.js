      ...
      <Container>
        <Row>
          <Col md="6">
            ...
            >
              <img src={"/image/coworking/jpg/content1-img1.jpg"} alt="" className="w-100 rounded-10" />
            </div>
          </Col>
          <Col md="6" data-aos="fade-up" data-aos-duration="1000">
            <div className="image-right mt-9 mt-lg-4 pl-xl-6">
              <img src={"/image/coworking/jpg/content1-img2.jpg"} alt="" className="w-100 rounded-10" />
            </div>
          </Col>
        </Row>
      </Container>
