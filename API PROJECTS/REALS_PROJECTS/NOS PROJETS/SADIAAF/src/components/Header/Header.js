        ...
        >
          <nav className="navbar site-navbar offcanvas-active navbar-expand-lg px-0">
            ...
            {gContext.header.button === "cta" && (
              <div className="header-btn ms-auto ms-lg-0 me-6 me-lg-0 d-none d-xs-block">
                <Link href="/#">
            ...
            {gContext.header.button === "account" && (
              <div className="header-btns d-none d-xs-block  ms-auto ms-lg-3 me-6 me-lg-0">
                <Link href="/signin">
                  <a className="btn-link gr-text-11 font-weight-bold gr-text-color ps-lg-8 ms-lg-2 border-lg-left me-9 me-lg-0">
                    Sign In
                  </a>
                </Link>
                <Link href="/signup">
