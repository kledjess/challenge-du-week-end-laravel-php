            ...
            <Row className="justify-content-center mt-md-6 pt-24 pt-lg-29">
              ...
              <Col xs="12">
                <div className="banner-fluid-image pt-lg-9">
                  <img src={"/image/inner/about-banner.png"} alt="" className="w-100" />
                </div>
              </Col>
            </Row>
          </Container>
          ...
          <Container>
            ...
            <Row className="justify-content-left mb-lg-n15 mb-0">
              <Col lg="3" md="4" xs="6" className="mb-lg-15 mb-13">
                <div className="team-card">
                  <div className="card-image">
                    <img src={"/image/inner/team-image-1.png"} alt="" className="w-100" />
                  </div>
              ...
              <Col lg="3" md="4" xs="6" className="mb-lg-15 mb-13">
                <div className="team-card">
                  <div className="card-image">
                    <img src={"/image/inner/team-image-2.png"} alt="" className="w-100" />
                  </div>
                  <div className="card-text pt-9">
              ...
              <Col lg="3" md="4" xs="6" className="mb-lg-15 mb-13">
                <div className="team-card">
                  <div className="card-image">
                    <img src={"/image/inner/team-image-3.png"} alt="" className="w-100" />
                  </div>
                  <div className="card-text pt-9">
              ...
              <Col lg="3" md="4" xs="6" className="mb-lg-15 mb-13">
                <div className="team-card">
                  <div className="card-image">
                    <img src={"/image/inner/team-image-4.png"} alt="" className="w-100" />
                  </div>
                  <div className="card-text pt-9">
              ...
              <Col lg="3" md="4" xs="6" className="mb-lg-15 mb-13">
                <div className="team-card">
                  <div className="card-image">
                    <img src={"/image/inner/team-image-5.png"} alt="" className="w-100" />
                  </div>
                  <div className="card-text pt-9">
              ...
              <Col lg="3" md="4" xs="6" className="mb-lg-15 mb-13">
                <div className="team-card">
                  <div className="card-image">
                    <img src={"/image/inner/team-image-6.png"} alt="" className="w-100" />
                  </div>
                  <div className="card-text pt-9">
              ...
              <Col lg="3" md="4" xs="6" className="mb-lg-15 mb-13">
                <div className="team-card">
                  <div className="card-image">
                    <img src={"/image/inner/team-image-7.png"} alt="" className="w-100" />
                  </div>
                  <div className="card-text pt-9">
